...
import { styled, Paper, Container, Grid, Divider } from "@mui/material";
...
const TopSection = styled('div')(({ theme }) => ({
	height: "30vh",
	// backgroundImage: 'url("https://i.ibb.co/WktkPxw/topBg.jpg")',
...
const PracticsTopPaper = styled(Paper)(({ theme }) => ({
	marginTop: "-10vh",
	zIndex: 2,
	marginBottom: "30px",
}));
...
const StyledUl = styled('ul')(({ theme }) => ({
	listStyleImage: "url('https://res.cloudinary.com/qualifier/image/upload/v1585479266/Default/check-mark_zbl05t.svg')",
	"& li": {
		fontSize: "0.9rem",
		lineHeight: 1.5,
		paddingLeft: 8,
...
export default function PracticeHome() {
	document.title = "Practice For FREE : Qualifier - Online Test Series & Practice - Railway, SSC, Banking, Placement Papers & CBSE Exams For FREE";
					...
					<Grid container spacing={4}>
						...
						<Grid item xs={12} style={{ display: "flex", justifyContent: "center" }} md={5}>
							<StyledUl>
								...
								<li>Save Question for future</li>
