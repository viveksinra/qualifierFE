...
import { Paper, Container, Grid, Divider, Typography, styled } from "@mui/material";
...
const StyledCharity = styled('div')(({ theme }) => ({
...
const StyledCharText = styled(Typography)(({ theme }) => ({
	textAlign: "center",
	paddingTop: 130,
		...
		<Fragment>
			...
			<Container>
				<Paper>
					...
					<Typography color="textSecondary" component={StyledPadding}>
					...
					<b />
					<b />
					<Typography color="primary" gutterBottom variant="body1" component={StyledPadding}>
						Acceptance
					</Typography>
					<b />
					<Typography color="textSecondary" component={StyledPadding}>
