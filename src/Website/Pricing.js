...
const usePriceTop = makeStyles((theme) => ({
	priceTopBg: {
...
export default function Pricing() {
	...
	return (
		<Fragment>
			...
			<div className={classes.priceTopBg} />
		...
		<div className={classes.pricingBg}>
			...
			<Container>
					...
					{priceData &&
						priceData.finalArray.map((p, i) => (
							<Grid item xs={12} key={i} md={4}>
								<div
									onClick={() => handlePay(p)}
									className={clsx(classes.priceCard, i === 0 ? classes.firstCard : i === 1 ? classes.secondCard : classes.thirdCard)}
								>
									<Typography align="center" className={classes.plan} variant="h6">
										{p.plan}
									</Typography>
									<Grid container spacing={2}>
										<Grid item xs={5}>
											<Typography align="center" color="primary" className={classes.vilidityText} variant="h5">
												<b>{p.period}</b> Days
											</Typography>
										...
										<Grid item xs={2}>
											<Divider orientation="vertical" style={{ height: "6rem" }} className={classes.cross} />
										</Grid>
										<Grid item xs={5}>
											...
											<Typography align="center" color="primary" className={classes.priceText} variant="h5">
												{"\u00A0"} {"\u00A0"} <FaRupeeSign /> {p.price} /-
											</Typography>
										</Grid>
									</Grid>
									...
									<center>
										<Badge color="secondary" badgeContent={`${p.off}`}>
											<Fab variant="extended" size="medium" color="primary" className={classes.fab} aria-label="add">
												Buy Now
				...
				<Grid item xs={12} style={{ marginTop: "50px" }}>
					...
					<Collapse in={showPromo}>
						<Paper component="form" className={classes.promoPaper}>
							<InputBase
...
const usePriceCard = makeStyles((theme) => ({
	pricingBg: {
		paddingTop: "30px",
		paddingBottom: "30px",
	...
	priceCard: {
		...
		maxWidth: "400px",
		// background: "radial-gradient(circle, rgba(149,238,219,0.36) 0%, rgba(148,187,233,0.21) 80%)",
		borderRadius: "20px",
		"&:hover": {
