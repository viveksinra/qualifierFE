...
import { Paper, Container, Grid, Divider, Typography } from "@mui/material";
import { FullNav, HideOnScroll } from "../Components/Navigation/Nav";
import Footer from "../Components/Footer/Footer";
import Typewriter from "typewriter-effect";
import { styled } from '@mui/material/styles';

const PREFIX = 'AppPrivacy';

const classes = {
	priceTopBg: `${PREFIX}-priceTopBg`,
	practicsTop: `${PREFIX}-practicsTop`,
...
const StyledFragment = styled(Fragment)(({ theme }) => ({
	...
	[`& .${classes.ul}`]: {
		// Add potential default ul styles if needed
	},
	[`& .${classes.li}`]: {
		// Add potential default li styles if needed
	},
	[`& .${classes.cross}`]: {
		// Add potential Divider styles if needed
	}
}));
