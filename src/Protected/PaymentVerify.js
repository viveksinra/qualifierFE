...
const PREFIX = 'PaymentVerify';
const classes = {
	topBg: `${PREFIX}-topBg`,
	container: `${PREFIX}-container`,
	paper: `${PREFIX}-paper`,
	success: `${PREFIX}-success`,
	successTag: `${PREFIX}-successTag`,
	img: `${PREFIX}-img`,
	transac: `${PREFIX}-transac`,
	fail: `${PREFIX}-fail`,
	failTag: `${PREFIX}-failTag`,
	transacFail: `${PREFIX}-transacFail`
};
...
const StyledFragment = styled(Fragment)(({ theme }) => ({
	...
	[`& .${classes.paper}`]: { padding: theme.spacing(3), borderTopLeftRadius: "20px", borderTopRightRadius: "20px" },
	[`& .${classes.success}`]: {
